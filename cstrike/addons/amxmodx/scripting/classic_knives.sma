            ...
            default: 
            {
                ...
                else if ( iSection == SECTION_MAIN_SETTINGS )
                {
                    ...
                    else if ( equal( szKey, "KNIFE_INFO" ) )
                    {
                        ...
                        clamp( g_eSettings[ KNIFE_INFO ], 0, 3 )
                    } 
                    ...
                    else if ( equal( szKey, "BHOP_INFO" ) )
                    {
                        ...
                        clamp( g_eSettings[ BHOP_INFO ], 0, 3 )
                    }
...
stock checkFlags( id )
{
    ...
    {
        case FLAG_ANY: { if ( g_eSettings[ KNIFE_INFO_FLAGS ] & g_ePlayerData[ id ][ PDATA_ADMIN_FLAGS ] )                                      g_ePlayerData[ id ][ PDATA_KNIFE_INFO ] = true; }
        case FLAG_ALL: { if ( g_eSettings[ KNIFE_INFO_FLAGS ] & g_ePlayerData[ id ][ PDATA_ADMIN_FLAGS ] == g_eSettings[ KNIFE_INFO_FLAGS ] )   g_ePlayerData[ id ][ PDATA_KNIFE_INFO ] = true; }
        case FLAG_DISABLED: g_ePlayerData[ id ][ PDATA_KNIFE_INFO ] = false
        default: g_ePlayerData[ id ][ PDATA_KNIFE_INFO ] = true
    }

    switch( g_eSettings[ BHOP_INFO ] )
    {
        case FLAG_ANY: { if ( g_eSettings[ BHOP_INFO_FLAGS ] & g_ePlayerData[ id ][ PDATA_ADMIN_FLAGS ] )                                       g_ePlayerData[ id ][ PDATA_BHOP ] = true; }
        case FLAG_ALL: { if ( g_eSettings[ BHOP_INFO_FLAGS ] & g_ePlayerData[ id ][ PDATA_ADMIN_FLAGS ] == g_eSettings[ BHOP_INFO_FLAGS ] )     g_ePlayerData[ id ][ PDATA_BHOP ] = true; }
        case FLAG_DISABLED: g_ePlayerData[ id ][ PDATA_BHOP ] = false
        default: g_ePlayerData[ id ][ PDATA_BHOP ] = true
    }
}
